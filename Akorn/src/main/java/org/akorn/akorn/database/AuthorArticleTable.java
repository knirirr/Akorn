 ...
 */
public class AuthorArticleTable
{
  /*
  ...
  */
  public static final String TABLE_AUTHORS_ARTICLES = "authors_articles";
  ...
  public static void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion)
  {
    Log.w(ArticleTable.class.getName(), "Upgrading database from version "
        ...
        + " and dropping data.");
    database.execSQL("DROP TABLE IF EXISTS " + TABLE_AUTHORS_ARTICLES);
    onCreate(database);
  }
}
